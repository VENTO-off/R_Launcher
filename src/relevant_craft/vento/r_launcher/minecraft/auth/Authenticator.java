package relevant_craft.vento.r_launcher.minecraft.auth;

import relevant_craft.vento.r_launcher.minecraft.auth.exceptions.*;
import relevant_craft.vento.r_launcher.minecraft.auth.responses.*;
...
public class Authenticator {
     ...
     * @see Authenticator#authenticate(String username, String password)
     * @see Authenticator#authenticate(String username, String password, String clientToken)
     */
    public static AuthenticationResponse authenticate(String username, String password, String clientToken, Proxy proxy) throws RequestException, AuthenticationUnavailableException {
        ...
        if (result.isSuccessful()) {
            ...
            if (selectedProfile == null) {
                throw new LicenceNotBoughtException();
            }
     ...
     * @throws InvalidCredentialsException        bad or empty username/password pair
     * @throws UserMigratedException              email should be used as username instead of nickname
     * @see Authenticator#authenticate(String username, String password, String clientToken, Proxy proxy)
     * @see Authenticator#authenticate(String username, String password)
     */
     ...
     * @see Authenticator#refresh(String accessToken, String clientToken)
     */
     ...
     * @throws AuthenticationUnavailableException the servers are unreachable
     * @throws InvalidTokenException              the provided token is invalid
     * @see Authenticator#refresh(String accessToken, String clientToken, Proxy proxy)
     */
     ...
     * @throws AuthenticationUnavailableException the servers are unreachable
     * @throws InvalidTokenException              the provided token is invalid
     * @see Authenticator#validate(String accessToken)
     * @see Authenticator#validate(String accessToken, String clientToken)
     */
     ...
     * @throws InvalidTokenException              the provided token is invalid
     * @see Authenticator#validate(String accessToken)
     * @see Authenticator#validate(String accessToken, String clientToken, Proxy proxy)
     */
     ...
     * @throws AuthenticationUnavailableException the servers are unreachable
     * @throws InvalidTokenException              the provided token is invalid
     * @see Authenticator#invalidate(String accessToken, String clientToken)
     */
     ...
     * @throws AuthenticationUnavailableException the servers are unreachable
     * @throws InvalidTokenException              the provided token is invalid
     * @see Authenticator#invalidate(String accessToken, String clientToken, Proxy proxy)
     */
     ...
     * @throws InvalidCredentialsException        bad or empty username/password pair
     * @throws UserMigratedException              email should be used as username instead of nickname
     * @see Authenticator#signout(String username, String password)
     */
     ...
     * @throws UserMigratedException              email should be used as username instead of nickname
     * @see Authenticator#signout(String username, String password)
     * @see Authenticator#signout(String username, String password, String clientToken, Proxy proxy)
     */
     ...
     * @throws InvalidCredentialsException        bad or empty username/password pair
     * @throws UserMigratedException              email should be used as username instead of nickname
     * @see Authenticator#signout(String username, String password, String clientToken)
     * @see Authenticator#signout(String username, String password, String clientToken, Proxy proxy)
     */
    ...
    public static RequestResponse sendJsonPostRequest(URL requestUrl, String payload, Proxy proxy) throws AuthenticationUnavailableException {
